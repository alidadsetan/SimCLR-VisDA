...
if args.action == "finetune":
    ...
    train_dataset = VisdaTrainDataset((storage_path/'train').resolve(), transform=contrast_transforms,n_views=5)

    valid_dataset = VisdaValidDataset((storage_path/'validation').resolve(), transform=contrast_transforms)
